...
// Define valid role types based on the enum in the database
export type UserRole = "patient" | "doctor" | "nutritionist" | "administrator" | "reception" | "aibot";
...
export async function createUserRole(userId: string, role: UserRole): Promise<any> {
  try {
...
// Removed problematic helper functions that used non-existing RPCs
