...
import { Send, X, MessageCircle, FileText, VolumeX, Volume2, MessageSquare } from 'lucide-react';
...
const welcomeMessages = {
  ...
  kn: "ನಮಸ್ಕಾರ! ��ಾನು ನಿಮ್�� Anubhuti ಸಹಾಯಕ. ಇಂದು ನಾನು ನಿಮಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಬಹುದು? ನೀವು ನಿಮ್ಮನ್��ು ನಮ್ಮ ವೈದ್ಯರು, ಕ್ಲಿನಿಕ್ ಸ್ಥಳ ಅಥವಾ ಸೇವೆಗಳ ಬಗ್ಗೆ ಕೇಳಬಹುದು.",
