    ...
    <Card className="bg-white">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <CheckCircle2 className={`h-5 w-5 ${(['care_team_assigned', 'fully_registered'] as RegistrationStatus[]).includes(registrationStatus.registration_status as RegistrationStatus) ? 'text-green-500' : 'text-gray-300'}`} />
              <span>Care Team Assignment</span>
            </div>
            <span className="text-sm text-muted-foreground">
              {(['care_team_assigned', 'fully_registered'] as RegistrationStatus[]).includes(registrationStatus.registration_status as RegistrationStatus) ? 'Completed' : 'In Progress'}
            </span>
          </div>
