...
export const OfferingCard = ({ title, image, description, features, className }: OfferingProps & { className?: string }) => {
  ...
  return (
    ...
    >
      <Card
        ...
        className={cn(
          "flex flex-col rounded-2xl bg-gradient-to-br from-gray-800/90 to-gray-900/90 backdrop-blur-lg overflow-hidden shadow-lg border border-white/5 group transition-all duration-500",
          className
        )}
      >
...
export const OfferingsSection = () => {
  return (
    <section
      id="offerings"
      className="py-32 relative overflow-hidden bg-gradient-to-br from-gray-950 via-gray-900 to-black"
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 mb-20">
          {offerings.map((offering, index) => (
            <OfferingCard key={index} {...offering} className="h-full" />
          ))}
        </div>
