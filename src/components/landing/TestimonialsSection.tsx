...
export const TestimonialCard = ({ quote, author, avatar, stars, role }: TestimonialProps) => {
  return (
    <Card className="overflow-hidden border-none shadow-lg animate-fade-up h-full flex flex-col">
  ...
  return (
    <section id="testimonials" className="py-24 bg-gray-50 overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-20 bg-white rounded-2xl p-8 shadow-md" data-animate>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { label: "Users Helped", value: "9,500+", description: "Happy clients on their health journey" },
              { label: "Average Weight Loss", value: "8.3 kg", description: "In first 3 months of program" },
              { label: "Diabetes Reversal", value: "87%", description: "Success rate in reducing medication" }
            ].map((stat, i) => (
