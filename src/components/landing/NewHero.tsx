...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return <section className="relative min-h-[70vh] sm:min-h-[90vh] flex items-center pt-12 sm:pt-16 md:pt-20 overflow-hidden" style={{
    background: 'linear-gradient(135deg, #4a2f80 0%, #6b46c1 100%)'
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-[40%] right-[15%] w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 rounded-2xl border-2 overflow-hidden animate-float-slow">
          <div className="w-full h-full flex items-center justify-center">
            <img src="/lovable-uploads/e42732ca-e658-4992-8a2d-863555e56873.png" alt="Doctor illustration" className="w-full h-full object-contain" />
          </div>
        </div>
        
        <div className="absolute bottom-[30%] right-[25%] w-20 h-20 sm:w-24 sm:h-24 border-2 rounded-2xl overflow-hidden animate-float" style={{
        animationDelay: '0.5s'
      }}>
          <div className="w-full h-full flex items-center justify-center">
            <img src="/lovable-uploads/5989b36b-4d21-46b9-9fee-38c13b8afdf3.png" alt="Health activity illustration" className="w-full h-full object-contain p-1" />
          </div>
        </div>
        
        <div className="absolute top-[35%] left-[30%] w-20 h-20 sm:w-24 sm:h-24 border-2 rounded-2xl overflow-hidden animate-float-slow" style={{
        animationDelay: '0.7s'
      }}>
        ...
        <div className="absolute bottom-0 left-[5%] w-48 h-16 sm:w-56 sm:h-20 overflow-hidden rounded-t-lg border-2 border-b-0">
          <div className="w-full h-full bg-cyan-500 grid grid-cols-5 text-center">
            {['25', '26', '27', '28', '29'].map((day, i) => <div key={i} className="flex flex-col items-center justify-center text-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-center">
          <div className={`w-full md:w-1/2 text-white text-center md:text-left mb-6 md:mb-0 ${isLoaded ? 'animate-fade-up' : 'opacity-0'}`} style={{
          animationDelay: '0.2s'
        }}>
          ...
          <div className={`w-full md:w-1/2 flex justify-center ${isLoaded ? 'animate-fade-up' : 'opacity-0'}`} style={{
          animationDelay: '0.4s'
        }}>
            <div className="w-[55%] sm:w-[45%] md:w-[60%] lg:w-[50%] max-w-[280px]">
              ...
              <div className="relative bg-black rounded-3xl overflow-hidden border-4 border-[#333] shadow-2xl w-full">
                ...
                <div className="bg-[#00b5e2] text-white p-0.5 sm:p-2 flex justify-between items-center rounded-lg mx-1.5 sm:mx-3">
                  ...
                  {['Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map((day, index) => <div key={day} className="text-center flex flex-col items-center">
                ...
                <div className="flex justify-between items-center my-1 sm:my-3 px-2 sm:px-4">
                  ...
                  <div className="w-10 sm:w-16 h-14 sm:h-20">
                    <img src="/lovable-uploads/e42732ca-e658-4992-8a2d-863555e56873.png" alt="Doctor avatar" className="w-full h-full object-contain" />
                  </div>
                </div>
                ...
                <div className="py-1 sm:py-2 px-1 sm:px-3 space-y-1 sm:space-y-2">
                  <div className="flex items-center space-x-1 sm:space-x-2">
                    <div className="w-5 h-5 sm:w-8 sm:h-8">
                      <img src="/lovable-uploads/90f15a11-74d0-46f1-8b5f-38cb0b2595d4.png" alt="AI badge" className="w-full h-full object-contain" />
                    </div>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="w-8 h-8 sm:w-12 sm:h-12">
                      <img src="/lovable-uploads/e2178f5b-75e8-47aa-909a-2340b57758dd.png" alt="Activity" className="w-full h-full object-contain" />
                    </div>
                    <div className="flex flex-col flex-1 items-end">
                      <div className="flex items-center gap-1">
                        <img src="/lovable-uploads/85c51479-e739-41cb-92db-1f9331c6e677.png" alt="Anubhooti Logo" className="w-3 h-3 sm:w-5 sm:h-5 object-contain" />
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 80" preserveAspectRatio="none" className="w-full h-[30px] md:h-[80px]">
          <path fill="#ffffff" fillOpacity="1" d="M0,64L120,69.3C240,75,480,85,720,80C960,75,1200,53,1320,42.7L1440,32L1440,80L1320,80C1200,80,960,80,720,80C480,80,240,80,120,80L0,80Z">
          </path>
        </svg>
      </div>
    </section>;
