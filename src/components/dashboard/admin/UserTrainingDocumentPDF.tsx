...
export const UserTrainingDocumentPDF = () => {
  ...
  return (
    <div>
                  ...
                  <div id="preview-architecture-document" className="prose max-w-none">
                    ...
                    <div className="mb-10">
                      ...
                      <div className="mb-4 p-6 border-2 border-dashed border-gray-300 rounded-lg text-center bg-gray-50">
                        ...
                        <p className="text-gray-400 text-xs mt-2">This is a placeholder. The actual document contains a detailed architecture diagram.</p>
                      </div>
                    ...
                    <div className="my-6 text-center text-muted-foreground">
                      <p>— Preview abbreviated —</p>
                      <p>The full document contains detailed architecture diagrams and component relationships.</p>
                    </div>
                  </div>
                </div>
              </ScrollArea>
                  ...
                  <div id="preview-highLevel-document" className="prose max-w-none">
                    ...
                    <div className="mb-10">
                      ...
                      <div className="mb-4 p-6 border-2 border-dashed border-gray-300 rounded-lg text-center bg-gray-50">
                        ...
                        <p className="text-gray-400 text-xs mt-2">The actual document contains a detailed data flow diagram.</p>
                      </div>
                    </div>
                    ...
                    <div className="my-6 text-center text-muted-foreground">
                      <p>— Preview abbreviated —</p>
                      <p>The full document contains detailed module specifications, API endpoints, and integration details.</p>
                    </div>
                  </div>
                </div>
              </ScrollArea>
              ...
              <ScrollArea className="flex-grow h-[calc(90vh-180px)]">
                <div className="p-6">
                  <div id="preview-lowLevel-document" className="prose max-w-none">
                    ...
                    <div className="my-6 text-center text-muted-foreground">
                      <p>— Preview abbreviated —</p>
                      <p>The full document contains detailed table schemas, function implementations, and component specifications.</p>
                    </div>
                  </div>
                </div>
              </ScrollArea>
      ...
      {/* Hidden content that will be converted to PDF - User Training Document */}
