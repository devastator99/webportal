...
import { AppointmentFormData, appointmentFormSchema } from "../schedule/schema";
import { NewAppointmentFormFields } from "./NewAppointmentFormFields";

interface NewScheduleAppointmentDialogProps {
  children: React.ReactNode;
  callerRole: "patient" | "doctor" | "reception";
}

export function NewScheduleAppointmentDialog({ 
  children, 
  callerRole 
}: NewScheduleAppointmentDialogProps) {
