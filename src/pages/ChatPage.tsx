...
const ChatPage = () => {
  ...
  if (isLoading || (userRole === UserRole.patient && loadingRoom)) {
    return (
      <div className="container pt-24 animate-fade-in">
        <div className="mx-auto flex flex-col items-center justify-center space-y-4">
          ...
          <p className="text-muted-foreground text-sm">
            {userRole === UserRole.patient ? 'Loading your care team chat...' : 'Loading chat...'}
          </p>
        </div>
      </div>
    );
  ...
  if (!user || userRole === UserRole.patient) return null;
  ...
  return (
    <div className="container pt-16 md:pt-20">
      <ErrorBoundary>
        ...
        {userRole === UserRole.patient && roomError && !patientRoomId && (
        ...
        <div className="h-[calc(100vh-220px)]">
          <WhatsAppStyleChatInterface 
            patientRoomId={userRole === UserRole.patient ? patientRoomId : undefined} 
          />
        </div>
      </ErrorBoundary>
    </div>
