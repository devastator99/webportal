...
-- Ensure all functions are correctly defined with consistent parameter names
-- Fix the get_doctor_patients_count function to use a consistent parameter name
...
-- Fix the get_doctor_medical_records_count function to use a consistent parameter name
...
-- Recreate the get_doctor_todays_appointments_count function to use 'doctor_id' parameter
...
-- Recreate the get_doctor_upcoming_appointments_count function to use 'doctor_id' parameter
